  ...
  function PlayerCard(
    ...
    return (
      <article
        ...
        {...rest}
      >
        {isActive && dragHandleAttributes != null && dragHandleListeners != null && (
          <span
            {...dragHandleAttributes}
            {...dragHandleListeners}
            className="-mr-6 flex min-h-0 min-w-[4rem] shrink-0 cursor-grab touch-manipulation items-center justify-start self-stretch rounded pl-0.5 pr-0.5 py-0.5 text-muted transition-colors duration-150 hover:bg-border/40 hover:text-foreground active:cursor-grabbing"
